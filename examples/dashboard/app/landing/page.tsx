...
function useGitHubStars() {
  ...
  useEffect(() => {
    fetch('https://api.github.com/repos/jacob119/market-pulse')
      .then(res => res.json())
          ...
          <div className="relative max-w-2xl mx-auto">
            ...
            <Card className="relative bg-zinc-900/90 border-zinc-800 backdrop-blur-xl overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-3 border-b border-zinc-800 bg-zinc-900/50">
                ...
                <span className="text-xs font-mono text-zinc-500 ml-2">market-pulse — python</span>
              </div>
      ...
      <section className="relative py-32 px-4">
        <div className="max-w-3xl mx-auto">
              ...
              <CardContent className="p-0">
                <pre className="p-6 text-sm font-mono overflow-x-auto">
                  <code className="text-zinc-400">
                    ...
                    {'\n'}
                    <span className="text-emerald-400">git clone</span> https://github.com/jacob119/market-pulse.git
                    {'\n'}
                    <span className="text-cyan-400">cd</span> market-pulse
                    {'\n\n'}
          ...
          <p className="text-center text-sm text-zinc-600 mt-6">
            Or try the{' '}
            <a
              href="https://github.com/jacob119/market-pulse#option-b-docker-recommended-for-production"
              target="_blank"
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              asChild
            >
              <a href="https://github.com/sponsors/jacob119" target="_blank" rel="noopener noreferrer">

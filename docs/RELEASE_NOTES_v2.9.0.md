...
MarketPulse v2.9.0은 **외부 기여자 3인의 주요 기능 추가**와 **매매 안정성 버그 수정**에 초점을 맞춘 마이너 버전입니다.
...
하나의 MarketPulse 인스턴스로 KIS API **주계좌와 부계좌를 동시 운용**할 수 있습니다.
